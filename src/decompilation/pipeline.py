...
class DecompilationPipeline:
    ...
    def run(self) -> None:
        ...
        if self.config.run_pruning:
            self.logger.info("=" * 60)
            self.logger.info("Stage 1/4: Causal pruning")
            self.logger.info("=" * 60)
        ...
        if self.config.run_mlp_primitives:
            self.logger.info("=" * 60)
            self.logger.info("Stage 2/4: MLP primitive replacement")
            self.logger.info("=" * 60)
        ...
        if self.config.run_att_primitives:
            self.logger.info("=" * 60)
            self.logger.info("Stage 3/4: Attention primitive replacement")
            self.logger.info("=" * 60)
        ...
        if self.config.run_conversion:
            self.logger.info("=" * 60)
            self.logger.info("Stage 4/4: D-RASP Conversion")
            self.logger.info("=" * 60)
            RaspPipeline(self.config.rasp).run()
